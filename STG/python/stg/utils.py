...
def stmap(func, iterable):
    ...
    elif isinstance(iterable, (collections.abc.Sequence, collections.UserList)): ## collections.Sequence 수정
        return [stmap(func, v) for v in iterable]
    elif isinstance(iterable, collections.abc.Set): ##collections.Set 수정
        return {stmap(func, v) for v in iterable}
